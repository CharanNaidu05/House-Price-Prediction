...
# Assuming columns 'num_bedrooms', 'num_bathrooms', 'stories', 'location', and 'price'
data['area'] = data['area'].astype('category').cat.codes  # Encode categorical variables if needed

# Prepare feature and target variables
X = data[['bedrooms', 'bathrooms', 'stories', 'area']]  # Adjust features as needed
